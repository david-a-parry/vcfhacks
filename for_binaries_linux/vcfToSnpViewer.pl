...
vcfToSnpViewer - convert variants from a VCF file to per sample input files for SnpViewer (http://sourceforge.net/projects/snpviewer/)

=head1 SYNOPSIS

        vcfToSnpViewer -i [vcf file]  [options]
        vcfToSnpViewer -h (display help message)
        vcfToSnpViewer -m (display manual page)
