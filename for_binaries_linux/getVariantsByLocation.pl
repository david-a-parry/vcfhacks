...
getVariantsByLocation - print variants from a vcf file that lie within a list of genomic regions


=head1 SYNOPSIS
 
getVariantsByLocation -i [vars.vcf] -b [regions.bed] -o [output.vcf]
getVariantsByLocation -i [vars.vcf] -r [regions] -o [output.vcf]
getVariantsByLocation -i [vars.vcf] -v [other.vcf] -o [output.vcf]
...
sub write_header{
    ...
    print $OUT "$meta_head\n";
    print $OUT "##getVariantsByLocation=\"";
    my @opt_string = ();
