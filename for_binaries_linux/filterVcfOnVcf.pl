...
filterVcfOnVcf - filter a VCF file using variants from one or more other VCF files.

=head1 SYNOPSIS

filterVcfOnVcf -i <input vcf file> -f <vcfs to use to filter input> [options]

filterVcfOnVcf -i <input vcf file> -d <directory containing vcfs to use to filter input> [options]

filterVcfOnVcf -h (show help message)

filterVcfOnVcf -m (show manual page)
